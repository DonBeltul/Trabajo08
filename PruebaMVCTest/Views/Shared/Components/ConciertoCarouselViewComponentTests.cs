...
{
    [TestClass()]
    public class ConciertoCarouselViewComponentTests
    {
        ...
        {
            ConciertoCarouselViewComponent component = new ConciertoCarouselViewComponent(new EFGenericRepositorio<Concierto>(InitConfiguration()));
